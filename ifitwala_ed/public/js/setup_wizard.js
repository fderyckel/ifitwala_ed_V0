...
ifitwala_ed.setup.slides_settings = [
	{
		// Brand
		name: 'brand',
		icon: "fa fa-bookmark",
	...
	},
	{
		...
		validate: function () {
			...
			if(me.values.bank_account){
				frappe.call({
					async: false,
					method: "ifitwala_ed.accounting.doctype.account.chart_of_accounts.chart_of_accounts.validate_bank_account",
					args: {
		...
		set_fy_dates: function (slide) {
			...
			if (country) {
				var fy = ifitwala_ed.setup.fiscal_years[country];
		...
		charts_modal: function(slide, chart_template) {
			...
			let coa_tree = new frappe.ui.Tree({
				...
				label: parent,
				expandable: true,
				method: 'ifitwala_ed.accounting.utils.get_coa',
				args: {
...
ifitwala_ed.setup.fiscal_years = {
