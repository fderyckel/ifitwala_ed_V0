...
ifitwala_ed.payments = class payments extends ifitwala_ed.stock.StockController {
	make_payment() {
		var me = this;
	...
	show_amounts(){
		...
		$(this.$body).find('.outstanding_amount').text(format_currency(this.frm.doc.outstanding_amount, frappe.get_doc(":Organization", this.frm.doc.organization).default_currency));
		this.update_invoice();
	}
}
