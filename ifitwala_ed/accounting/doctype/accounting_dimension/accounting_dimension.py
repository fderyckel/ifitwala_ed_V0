...
class AccountingDimension(Document):
	...
	def validate(self):
		if self.document_type in core_doctypes_list + ('Accounting Dimension', 'Project',
				'Cost Center', 'Accounting Dimension Detail', 'Organization', 'Account') :
...
def get_checks_for_pl_and_bs_accounts():
	dimensions = frappe.db.sql("""SELECT p.label, p.disabled, p.fieldname, c.default_dimension, c.organization, c.mandatory_for_pl, c.mandatory_for_bs
...
def get_dimensions(with_cost_center_and_project=False):
	...
	default_dimensions = frappe.db.sql("""SELECT p.fieldname, c.organization, c.default_dimension
	...
	for dimension in default_dimensions:
		default_dimensions_map.setdefault(dimension.organization, {})
		default_dimensions_map[dimension.organization][dimension.fieldname] = dimension.default_dimension
